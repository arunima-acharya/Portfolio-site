...
export const ffHeading = "var(--font-fraunces), serif";
...
export function FloatingCard({ style, children }: { style: React.CSSProperties; children: React.ReactNode }) {
  return (
    <div style={{
      position: "absolute", background: "var(--sp-cream)", borderRadius: 12,
      border: "1.5px solid var(--sp-charcoal)", boxShadow: "rgba(0, 0, 0, 0.06) 0px 2px 20px 0px",
  ...
  return (
    <div
      ...
      style={{
        ...
        borderRadius: 12, padding: "26px 26px 24px", boxShadow: "rgba(0, 0, 0, 0.06) 0px 2px 20px 0px",
...
export function InsightCard({ badge, title, desc, children }: { badge?: string; title: string; desc: string; children: React.ReactNode }) {
  return (
    <div style={{
      ...
      padding: "26px 28px 32px", boxShadow: "rgba(0, 0, 0, 0.06) 0px 2px 20px 0px",
    }}>
      {badge && (
        <div style={{
          display: "inline-flex", alignItems: "center", gap: 5, marginBottom: 16, background: "rgba(255,111,30,0.12)",
...
export function SmallInsightCard({ title, desc, children }: { title: string; desc: string; children: React.ReactNode }) {
  return (
    <div style={{
      background: "var(--sp-cream)", border: "1.5px solid var(--sp-charcoal)", borderRadius: 12,
      padding: 22, boxShadow: "rgba(0, 0, 0, 0.06) 0px 2px 20px 0px",
    }}>
...
export function ResearchMethodsBar({ methods }: { methods: Array<{ label: string; value: string; displayLabel?: React.ReactNode }> }) {
  return (
    <div style={{
      ...
      maxWidth: 1160, margin: "40px auto 0", boxShadow: "rgba(0, 0, 0, 0.06) 0px 2px 20px 0px",
    }}>
...
export function MockTable({ rows = 4 }: { rows?: number }) {
  return (
    <div style={{ background: "var(--sp-dew)", border: "1.5px solid var(--sp-charcoal)", borderRadius: 8, padding: "9px 11px", display: "flex", flexDirection: "column", gap: 8 }}>
...
export function MockSelection() {
  return (
    <div style={{ background: "var(--sp-dew)", border: "1.5px solid var(--sp-charcoal)", borderRadius: 8, padding: "20px 12px 12px", display: "flex", flexDirection: "column", gap: 8 }}>
      {[0, 1].map((r) => (
...
export function MockAvatars() {
  return (
    <div style={{ background: "var(--sp-dew)", border: "1.5px solid var(--sp-charcoal)", borderRadius: 8, padding: "9px 11px", display: "flex", flexDirection: "column", gap: 9 }}>
...
export function MockForm() {
  return (
    <div style={{ background: "var(--sp-dew)", border: "1.5px solid var(--sp-charcoal)", borderRadius: 8, padding: "9px 11px", display: "flex", flexDirection: "column", gap: 7 }}>
      {[0, 1].map((i) => (
...
export function MockTimeline() {
  return (
    <div style={{ background: "var(--sp-dew)", border: "1.5px solid var(--sp-charcoal)", borderRadius: 8, padding: "10px 11px", display: "flex", flexDirection: "column", gap: 8 }}>
...
export function PrincipleCallout({ index, title, desc }: { index: string; title: string; desc: string }) {
  return (
    <div style={{
      ...
      <div style={{ fontSize: 16, fontWeight: 700, color: "var(--sp-charcoal)", fontFamily: ff, marginBottom: 8, lineHeight: 1.3 }}>{title}</div>
...
export function SolutionStep({ number, title, desc, reverse, children }: { number: string; title: string; desc: string; reverse?: boolean; children: React.ReactNode }) {
  return (
    <div style={{
      ...
      alignItems: "center", gap: 32, boxShadow: "rgba(0, 0, 0, 0.06) 0px 2px 20px 0px", overflow: "hidden",
    }}>
...
export function EmptyLessonCard() {
  return <div style={{ background: "var(--sp-dew)", borderRadius: 12, minHeight: 260 }} />;
}

...
export default function InfiniteMenu({ items = [], scale = 1.0 }) {
  ...
  return (
    <div className="relative w-full h-full" data-cursor-drag>
      <canvas
      ...
      {activeItem && (
        <>
          <p style={{
            ...
            transition: isMoving ? 'opacity 100ms ease' : 'opacity 500ms cubic-bezier(0.25,0.1,0.25,1.0)',
          }}>
            {activeItem.title}
          </p>
          <p style={{
            ...
            transform: isMobile ? 'none' : 'translateY(-50%)',
            fontSize: isMobile ? '0.85rem' : '1.54rem',
            fontWeight: 400,
            color: 'rgba(0,0,0,0.5)',
            fontFamily: 'Inter, sans-serif',
            margin: 0,
            pointerEvents: 'none',
            maxWidth: isMobile ? '70%' : '18%',
            textAlign: 'right',
            lineHeight: 1.4,
            whiteSpace: 'pre-line',
            opacity: isMoving ? 0 : 1,

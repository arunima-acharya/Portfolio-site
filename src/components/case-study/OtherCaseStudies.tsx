...
const FONT_HEADING = "var(--font-fraunces), serif";
const MAX_W = "1200px";
  ...
  return (
    ...
    >
      ...
      <div style={{ position: "relative", width: "100%", aspectRatio: "4/3", background: "var(--sp-dew)", overflow: "hidden" }}>
        ...
        <div style={{ position: "absolute", inset: 0, display: "flex", alignItems: "center", justifyContent: "center" }}>
          <span style={{
            fontFamily: FONT, fontSize: 16, fontWeight: 500, letterSpacing: "0.2em",
            textTransform: "uppercase", color: "rgba(23,23,23,0.16)",
    ...
    <section ref={ref} style={{ background: "var(--sp-cream)", padding: "80px 32px 15%" }}>
      <div style={{ maxWidth: MAX_W, margin: "0 auto" }}>
        ...
        <div style={{ marginBottom: 48, ...revealStyle(revealed) }}>
          <p style={{ fontFamily: FONT, fontSize: 16, color: "#8a8580", textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: 10 }}>More work</p>
          <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", gap: 24 }}>
            <h2 style={{ fontFamily: FONT_HEADING, fontWeight: 600, textTransform: "capitalize", fontSize: "clamp(28px,3.5vw,40px)", color: "var(--sp-cocoa)", lineHeight: 1.2 }}>Other case studies</h2>
            <Link
              href="/case-studies"

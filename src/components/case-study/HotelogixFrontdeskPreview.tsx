...
import LessonsLearnedPremium from "@/components/case-study/LessonsLearnedPremium";
  ...
  return (
    <div style={{ background: "var(--sp-cream)", border: "1.5px solid var(--sp-charcoal)", borderRadius: "var(--radius-xl)", padding: "20px 20px 24px" }}>
      <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 20 }}>
        <div style={{
          width: 34, height: 34, borderRadius: "var(--radius-lg)", background: "rgba(255,111,30,0.12)",
          display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0,
        }}>
          <span style={{ color: "var(--sp-orange)", display: "flex" }}>{icon}</span>
        </div>
...
function ResearchInsightCard({ title, desc }: { title: string; desc: string }) {
  return (
    <div style={{
      ...
      padding: "var(--spacing-24)", boxShadow: "var(--shadow-lg)",
    }}>
...
function PrincipleCallout({ index, title, desc }: { index: string; title: string; desc: string }) {
  return (
    <div style={{
      ...
      <div style={{ display: "flex", alignItems: "baseline", gap: "var(--spacing-8)", marginBottom: 8 }}>
    ...
    <>
      ...
      <section style={{ background: "var(--sp-cream)", padding: "90px 8%", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ position: "relative" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(5, 1fr)", gap: "var(--spacing-20)", maxWidth: 1160, margin: "0 auto" }}>
      ...
      <section style={{ background: "var(--sp-cream)", padding: "90px 8% 110px" }}>
        ...
        >
          {SOLUTION_STEPS.map((s) => (
            <ScrollStackItem
              ...
              style={{ height: "auto", padding: 0, borderRadius: "var(--radius-xl)", boxShadow: "none", background: "transparent" }}
            >
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "var(--spacing-16)", marginTop: 56, maxWidth: 1040, marginLeft: "auto", marginRight: "auto" }}>

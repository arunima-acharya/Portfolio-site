    ...
    <section className="relative overflow-hidden pt-32 pb-6" aria-label="Research hero">
      ...
      <div className="relative z-10 mx-auto px-6" style={{ maxWidth: 820 }}>
        ...
        >
          ...
          <span className="text-xs font-semibold uppercase tracking-[0.2em]" style={{ color: accentText }}>
            {eyebrow}
          </span>
        </motion.div>
        ...
        <motion.h1
          ...
          style={{ fontSize: "clamp(2.2rem, 5.2vw, 3.6rem)", lineHeight: 1.05, color: p.text }}
        >
          {project.title}
        </motion.h1>
        ...
        >
          {meta.map(({ label, value }) => (
            <div key={label} className="space-y-1.5">
              <p className="text-[11px] font-semibold uppercase tracking-[0.18em]" style={{ color: p.textFaint }}>{label}</p>

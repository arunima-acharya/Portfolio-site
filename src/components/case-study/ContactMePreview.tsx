  ...
  return (
    <>
      ...
      <section style={{ background: "var(--sp-cream)", padding: "70px 8% 100px" }}>
        <div style={{ fontSize: 16, fontWeight: 400, letterSpacing: "0.08em", color: "var(--sp-orange)", fontFamily: ff, marginBottom: "var(--spacing-32)", maxWidth: 1120, margin: "0 auto 32px" }}>
          10 — LESSONS LEARNED
        </div>

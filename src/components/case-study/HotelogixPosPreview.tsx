...
import LessonsLearnedPremium, { type PremiumLesson } from "@/components/case-study/LessonsLearnedPremium";
import {
  ff,
  ffHeading,
  SnapshotCard,
...
// Real POS screenshots, used for every placeholder except the Challenges
// section (which keeps its generated moduleThumbnail() placeholders). Cycled
// round-robin wherever more image slots exist than distinct files.
const POS_ASSET_IMAGES = [
  "/assets/POS/Draft 116.png",
  "/assets/POS/Draft 125.png",
  "/assets/POS/Draft 130.png",
  "/assets/POS/Draft 131.png",
  "/assets/POS/Draft 132.png",
  "/assets/POS/Draft 137.png",
  "/assets/POS/Draft 138.png",
  "/assets/POS/Draft 139.png",
  "/assets/POS/Draft 153.png",
  "/assets/POS/Draft 164.png",
  "/assets/POS/Draft 164-1.png",
  "/assets/POS/Draft 165.png",
  "/assets/POS/Draft 165-1.png",
  "/assets/POS/Draft 166.png",
  "/assets/POS/Draft 166-1.png",
  "/assets/POS/Draft 167.png",
  "/assets/POS/Draft 168.png",
];
function posAsset(index: number) {
  return POS_ASSET_IMAGES[index % POS_ASSET_IMAGES.length];
}
...
const SOLUTION_CARDS: Array<{
...
}> = [
  {
    ...
    imageLabel: "Table dashboard screenshot", imageHeight: 400, imageSrc: posAsset(1),
  },
  {
    number: "02",
    ...
    imageLabel: "Order management screenshot", imageHeight: 400, imageSrc: posAsset(2),
  },
  {
    number: "03",
    ...
    imageLabel: "Kitchen workflow screenshot", imageHeight: 400, imageSrc: posAsset(3),
  },
  {
    number: "04",
    ...
    imageLabel: "Billing screenshot", imageHeight: 400, imageSrc: posAsset(4),
  },
];
...
const POS_MODULES = POS_MODULE_NAMES.map((title, i) => ({
  title,
  link: "#",
  thumbnail: posAsset(5 + i),
}));
    ...
    <>
          ...
          <div style={{
            ...
            <div style={{ padding: "0 10px 10px" }}>
              <div style={{ background: "var(--sp-cream)", borderRadius: "var(--radius-lg)", overflow: "hidden" }}>
                <ScreenshotPlaceholder label="POS dashboard screenshot" height={653} src={posAsset(0)} fit="width" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section style={{ background: "var(--sp-cream)", padding: "90px 8%" }}>
        ...
        <TiltMockup style={{
          ...
          <ScreenshotPlaceholder label="Design system applied — POS component library mockup" height={666} src={posAsset(5)} fit="width" />
        </TiltMockup>
